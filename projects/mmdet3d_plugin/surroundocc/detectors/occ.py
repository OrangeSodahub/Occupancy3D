...
class Occ(MVXTwoStageDetector):
    def __init__(self,
        ...
        super(Occ, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def extract_points_feat(self, points):
    ...
    def extract_feat(self, img, img_metas=None, points=None, len_queue=None):
        ...
        if self.use_points and points is not None:
            voxel_pts_feats = self.extract_points_feat(points)

        return img_feats, voxel_pts_feats

    def forward_points_train(self,
                          img_feats,
                          voxel_pts_feats,
                          voxel_semantics,
                          mask_camera,
    ...
    def forward_train(self,
        ...
        losses = dict()
        losses_pts = self.forward_points_train(img_feats, voxel_pts_feats,
