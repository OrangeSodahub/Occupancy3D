...
class VisFuser(nn.Module):
    ...
    """
    def __init__(self, embed_dims, norm_cfg=None) -> None:
        super().__init__()
    ...
    def forward(self, img_voxel_feats_list, pts_voxel_feats, single_scale_fusion=False):

        # multi-level feature fusion
        voxel_feats_list = []
        
        for i, img_voxel_feats in enumerate(img_voxel_feats_list):
            if single_scale_fusion and i != len(img_voxel_feats_list) - 1:
                continue
